...
class _welcomeState extends State<welcome> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: const Color.fromARGB(255, 43, 203, 224),
        title: Text("Patient",
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: Divider(
                    thickness: 4,
                    color: Color.fromARGB(255, 43, 203, 224),
                  ),
                ),
              ],
            ),
        ...
        return Dismissible(
          ...
          background: Container(
            ...
            child: const Icon(Icons.delete,
                color: Color.fromARGB(255, 247, 49, 49)),
          ),
          child: Column(
              ...
              Padding(
                ...
                child: ListTile(
                  ...
                  trailing: IconButton(
                      ...
                      color: const Color.fromARGB(255, 211, 26, 12)),
                ),
              ),
              const Padding(
                padding: EdgeInsets.fromLTRB(25, 1, 25, 1),
                child: DottedLine(
                  dashColor: Color.fromARGB(255, 43, 203, 224),  // สีของเส้นประ
